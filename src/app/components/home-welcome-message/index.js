...
function HomeWelcomeMessage({ scrollProgress }) {
  ...
  return (
    <div className="home-text-block welcome-message" style={styles}>
      ...
      <h1>
        We make digital <span className="home-gradient-text-cold">products</span> and <span className="home-gradient-text-lukewarm">services</span> for the <span className="home-gradient-text-hot">smartest</span> brands
      </h1>
    </div>
  );
}
