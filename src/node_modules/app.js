      ...
      content = (
        <div className="app">
          <EntranceAnimation className="nav-wrapper" delay={headerDelay} duration={0.5} options={animationOptions} findElement={element => element.children[0]}>
            <Navigation pages={state.pages} customClass="transparent-white" section={this.state.currentPage.split('/')[0]} takeover={this.state.takeover !== Nulls.takeover} open={this.state.showNav} />
          </EntranceAnimation>
