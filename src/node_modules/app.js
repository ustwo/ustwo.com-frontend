...
const pageMap = {
  ...
  'case-study': require('templates/page-case-study'),
  'blog': require('templates/page-blog'),
  'post': require('templates/page-post')
};
      ...
      content = (
        <div className="app">
          <EntranceAnimation className="nav-wrapper" delay={headerDelay} duration={0.5} options={animationOptions} findElement={element => element.children[0]}>
            <Navigation pages={state.pages} customClass="transparent-white" page={this.state.currentPage} takeover={this.state.takeover !== Nulls.takeover} />
          </EntranceAnimation>
