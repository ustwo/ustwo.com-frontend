    ...
    if(this.state.showContent) {
      content = (
        <div key="detail" className="take-over__content">
          <CloseButton onClose={this.onClickClose} className="take-over__content__close" autoAnim={500} />
      ...
      content = <NewsFlash key="news-flash" className="take-over__news-flash" autoAnim={50} />;
    }
    return (
      <div className="take-over" onClick={onClickContent}>
        <TransitionManager className="take-over__content-wrapper" component="div" duration={500}>
          {content}
        </TransitionManager>
      </div>
    );
