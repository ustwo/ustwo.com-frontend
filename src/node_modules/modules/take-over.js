...
const takeover = {
  title: "We've just launched Moodnotes!",
...
export default class TakeOver extends React.Component {
  ...
  renderLink(link) {
    ...
    return <li className={`take-over__content__message__links__link-item ${link.type}`}><a className="take-over__content__message__links__link-item__link" href={`${prefix}${link.url}`}>{link.text}</a></li>;
  }
  componentDidMount() {
