...
export default class TakeOver extends React.Component {
      ...
      content = (
        <div key="detail" className="take-over__content">
          <div className="take-over__content__message">
            ...
            <div className="take-over__content__message__links">
  ...
  renderLink(link) {
    ...
    return <a className={`take-over__content__message__links__link ${link.type}`} href={`${prefix}${link.url}`}>{link.text}</a>;
  }
  componentDidMount() {
