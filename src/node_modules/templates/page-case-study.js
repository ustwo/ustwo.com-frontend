  ...
  render() {
    ...
    return (
      <article className="page-case-study">
        ...
        `}</style>
        <SingleColumn className="page-case-study__intro" title={get(caseStudy, 'name')} headingColour={get(caseStudy, 'colors.primary')} ruleColour={get(caseStudy, 'colors.secondary')}
      backgroundColour={get(caseStudy, 'colors.bg')} />
  ...
  renderModule = (moduleData) => {
    ...
    switch(moduleData.name) {
      ...
      case 'blockquote':
        module = (
          <QuoteBlock
              source={get(moduleData, 'attr.text.source')}
