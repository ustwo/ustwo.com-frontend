      ...
      <article className="page-home">
        <ScreenBlock ref="blockWelcome" customClass="page-home__screen-block--welcome" hexColour={'#' + this.state.blocks[0].hexColour}>
          <EntranceTransition className="entrance">
            <img className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_00.png"/>
            <Rotator delay={1400} duration={2000} interval={4000} keep={3}>
              <img key="image1" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_01.png"/>
              <img key="image2" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_02.png"/>
              <img key="image3" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_03.png"/>
              <img key="image4" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_04.png"/>
              <img key="image5" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_05.png"/>
              <img key="image6" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_06.png"/>
            </Rotator>
            <div className="strap-line">Strap line</div>
          </EntranceTransition>
          ...
          <div className="page-home__screen-block--client__image-vertical-centerer-parent">
            <div className="page-home__screen-block--client__image-vertical-centerer-parent__image-vertical-centerer-child">
              <div className="page-home__screen-block--client__image-vertical-centerer-parent__image-vertical-centerer-child__image-margin-container">
                ...
                <img className="page-home__screen-block--client__image-vertical-centerer-parent__image-vertical-centerer-child__image-margin-container__harvey-nicks-device" src="images/home/Homepage_Harvey_Phone.png"/>
          ...
          <div className="page-home__screen-block--own-stuff__image-vertical-centerer-parent">
            <div className="page-home__screen-block--own-stuff__image-vertical-centerer-parent__image-vertical-centerer-child">
              <div className="page-home__screen-block--own-stuff__image-vertical-centerer-parent__image-vertical-centerer-child__image-layer">
                ...
                <img className="page-home__screen-block--own-stuff__image-vertical-centerer-parent__image-vertical-centerer-child__image-layer__monument-device" src="images/home/Homepage_Games_Ipad.png"/>
              </div>
            </div>
          </div>
          ...
          <div className="page-home__screen-block--ventures__image-vertical-centerer-parent">
            <div className="page-home__screen-block--ventures__image-vertical-centerer-parent__image-vertical-centerer-child">
              <div className="page-home__screen-block--ventures__image-vertical-centerer-parent__image-vertical-centerer-child__image-layer">
                ...
                <img className="page-home__screen-block--ventures__image-vertical-centerer-parent__image-vertical-centerer-child__image-layer__dice-device" src="images/home/Homepage_Dice_Mask.png"/>
