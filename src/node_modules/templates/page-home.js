        ...
        <ScreenBlock ref="blockClient" customClass="page-home__screen-block--client" hexColour={this.state.blocks[1].hexColour}>
          <div className="page-home__screen-block--client__image-vertical-centerer">
            <div className="page-home__screen-block--client__image-vertical-centerer__image-margin-container">
              ...
              <HarveyNicksDevice className="page-home__screen-block--client__image-vertical-centerer__image-margin-container__harvey-nicks-device" src="images/home/Homepage_Harvey_Phone.png"/>
        ...
        <ScreenBlock ref="blockOwnStuff" customClass="page-home__screen-block--own-stuff" hexColour={this.state.blocks[2].hexColour}>
          <div className="page-home__screen-block--own-stuff__image-vertical-centerer">
            <div className="page-home__screen-block--own-stuff__image-vertical-centerer__image-layer-container">
              ...
              <MonumentDevice className="page-home__screen-block--own-stuff__image-vertical-centerer__image-layer-container__monument-device" src="images/home/Homepage_Games_Ipad.png"/>
            </div>
          </div>
