  ...
  render() {
    ...
    if (window.innerWidth <= 480) {
      ...
      Chevron = (<div className="down-chevron page-home__screen-block--welcome__down-chevron">
        <svg title="Down arrow" role="img" viewBox="0 0 400 200"><g>
      ...
      Watches = (<div><img className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_00_Mobile.png"/>
                <Rotator delay={1400} duration={2000} interval={4000} keep={3}>
                  <img key="image1" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_01_Mobile.png"/>
                  <img key="image2" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_02_Mobile.png"/>
                  <img key="image3" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_03_Mobile.png"/>
                  <img key="image4" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_04_Mobile.png"/>
                  <img key="image5" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_05_Mobile.png"/>
                  <img key="image6" className="page-home__screen-block--welcome__headline-background-image" src="images/home/Homepage_hero_06_Mobile.png"/>
                </Rotator></div>);
      Chevron = <DownChevron customClass="page-home__screen-block--welcome__down-chevron" ref="downChevron"/>;
    }
    return (
