  ...
  render() {
    ...
    return (
      <article className="page-work">
        <section className="page-hero" style={{backgroundImage: "url('/images/whatwedo/header/image_1.png')"}}>
          <h1 className="page-hero__title">{get(pageData, 'page_builder.0.attr.heading.value')}</h1>
          <img className="page-hero__image" src="/images/whatwedo/header/image_1.png" />
          <DownChevron customClass="page-hero__down-chevron" ref="downChevron" />
        </section>
        ...
        <ul className="page-work__list">
          {get(pageData, 'page_builder.2.attr.case_studies.value', '').split(',').map(caseStudyName => {
            ...
            const attachments = (pageData && pageData._embedded['http://v2.wp-api.org/attachment']) || [];
