      ...
      <article className="page-privacy">
        ...
        <div className="content-container">
          ...
          <ul>
            ...
            <li><a href="http://jamieking.co.uk/website-design.html">Web Design Wales</a></li>
            <li><a href="http://jamieking.co.uk/resources/free_sample_privacy_policy.html">Website Privacy Policy</a></li>
            <li><a href="http://jamieking.co.uk/kb/task-manager-project-planner-template.html">Project Planner Template</a></li>
          </ul>
