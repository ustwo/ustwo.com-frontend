  ...
  render() {
    ...
    return (
      <li className={classnames(this.props.className, 'work-item')} style={{backgroundColor: get(data, 'colors.bg')}}>
        <a href={link} onClick={Router.override(link)} className="work-item__image-link" style={{backgroundImage: `url('${get(data, 'image')}')`}}>
          <img className="work-item__image-link__image" src={get(data, 'image')} />
        </a>
